        ...
        <div class="row">
            ...
            <div class="info-card">
              ...
              <div class="row">
                ...
                <div class="col-md-6 chg-block" :class="[(ticker.percent < 0) ? 'down' : 'up']">
                  <div class="text-dark small text-right">24h Promjena cijene</div>
          ...
          <div class="col-md-4 mb-3">
            <div class="info-card justify-content-center">
              <div><span class="info-label">24H OPEN</span>{{ ticker.open | priceformat }}<span class="small">
                  {{ currency.quote }}</span></div>
              <div><span class="info-label">24H MAKS </span>{{ ticker.high | priceformat }}<span class="small">
                  {{ currency.quote }}</span></div>
              <div><span class="info-label">24H MIN </span>{{ ticker.low | priceformat }}<span class="small">
                  {{ currency.quote }}</span></div>
              <div><span class="info-label">24H VOL </span>{{ ticker.vol }}<span class="small"> {{ currency.base }}</span>
              </div>
            </div>
          </div>
