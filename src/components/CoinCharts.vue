        ...
        <div class="row chart-bar">
          <div class="chart-type">
            <button class="btn btn-primary btn-sm mr-2" :class="[{ 'active': chartType === 'cs' }]"
              @click="toCandleStickChart">Grafikon - svjećnjak</button>
            <button class="btn btn-primary btn-sm" :class="[{ 'active': chartType === 'lc' }]" @click="toLineChart">Linijski grafikon</button>
          </div>
        </div>
      </div>
